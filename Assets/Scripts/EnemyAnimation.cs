...
public class EnemyAnimation : MonoBehaviour
{
    ...
    public void PlayIdleAnimation()
    {
        ...
        else if (anim.IsPlaying("move_forward_fast"))
        {
    ...
    {
        if (CheckCurrentAnimation("move_forward")) return;

        if (anim.IsPlaying("move_forward_fast"))
        {
            anim.CrossFade("move_forward_fast");
        }
        else if (anim.IsPlaying("idle_normal"))
        {
    ...
    {
        if (CheckCurrentAnimation("move_forward_fast")) return;
