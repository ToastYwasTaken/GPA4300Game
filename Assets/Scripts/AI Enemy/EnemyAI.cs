 ...
 *              RK  Setze lookAroundFlag auf false, 
 *                  wenn der Spieler erkannt wurde
...
public class EnemyAI : MonoBehaviour
{
    ...
    private Action OnEnemyPatrol;
    private Action OnEnemyAttack;
    private Action OnEnemySeePlayer;
    ...
    {
        OnEnemyPatrol += _newFunc;
    }
    public void SetOnAttack(Action _newFunc)
    {
        OnEnemyAttack += _newFunc;
    }

    public void SetOnSeePlayer(Action _newFunc)
    {
        OnEnemySeePlayer += _newFunc;
    }
